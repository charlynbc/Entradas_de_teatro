...
import { readData } from './teatro-tickets-backend/utils/dataStore.js';
import { logger } from './teatro-tickets-backend/utils/logger.js';
import { validateEnvironment, validateOptionalEnvironment } from './teatro-tickets-backend/utils/envValidator.js';
import { initDatabase } from './teatro-tickets-backend/bootstrap/database.js';
import { initSuperUser } from './teatro-tickets-backend/bootstrap/superUser.js';
import { initSeed } from './teatro-tickets-backend/bootstrap/seed.js';
import pool from './teatro-tickets-backend/db/postgres.js';

// Routes imports
import authRoutes from './teatro-tickets-backend/routes/auth.routes.js';
import usersRoutes from './teatro-tickets-backend/routes/users.routes.js';
import usuariosRoutes from './teatro-tickets-backend/routes/usuarios.routes.js';
import funcionesRoutes from './teatro-tickets-backend/routes/funciones.routes.js';
import ticketsRoutes from './teatro-tickets-backend/routes/tickets.routes.js';
import reportesRoutes from './teatro-tickets-backend/routes/reportes.routes.js';
import reportesObrasRoutes from './teatro-tickets-backend/routes/reportes-obras.routes.js';
import ensayosRoutes from './teatro-tickets-backend/routes/ensayos.routes.js';
import adminRoutes from './teatro-tickets-backend/routes/admin.routes.js';
import gruposRoutes from './teatro-tickets-backend/routes/grupos.routes.js';
import obrasRoutes from './teatro-tickets-backend/routes/obras.routes.js';
import uploadRoutes from './teatro-tickets-backend/routes/upload.routes.js';
import publicRoutes from './teatro-tickets-backend/routes/public.routes.js';
import auditoriaReportesRoutes from './teatro-tickets-backend/routes/auditoria-reportes.routes.js';
import cuotasRoutes from './teatro-tickets-backend/routes/cuotas.routes.js';
import gastosRoutes from './teatro-tickets-backend/routes/gastos.routes.js';
import boleteriaRoutes from './teatro-tickets-backend/routes/boleteria.routes.js';
import contabilidadRoutes from './teatro-tickets-backend/routes/contabilidad.routes.js';
import pagosRoutes from './teatro-tickets-backend/routes/pagos.routes.js';
import entradasV2Routes from './teatro-tickets-backend/routes/entradasV2.routes.js';
